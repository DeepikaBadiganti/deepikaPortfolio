...
export const projectsData = [
  ...
  },
  {
    name: "Match Game",
    description:
      "Match Game is a timed memory challenge where users have 60 seconds to match as many identical images as possible. The game displays a grid of images, and the player's objective is to find matching pairs within the time limit. Each successful match earns the player points, with the score increasing based on how many pairs they can match. It’s a fun and engaging game that tests quick thinking and memory skills. ",
    technologies: [
      "React.js",
      "CSS",
      "java script",
